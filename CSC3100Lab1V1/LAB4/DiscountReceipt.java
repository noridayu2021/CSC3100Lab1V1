...
//MATRIX	: 210468
//LAB		: 4
//QUESTION	: Print A Receipt after discount
import java.util.Scanner;
public class DiscountReceipt {
public static void main(String[]args) {

Scanner input= new Scanner(System.in); 
System.out.println("This is CSC3100 Mart");
...
System.out.println ("Quantity of Item2");
...
System.out.println("Grandtotal after discount" +  Grandtotal);

System.out.println("PAY THIS AMOUNT IF YOU WANNA LEAVE THIS STORE"   +   Grandtotal);
